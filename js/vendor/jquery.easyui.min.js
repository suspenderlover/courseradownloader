...
},plugins:["draggable","droppable","resizable","pagination","tooltip","linkbutton","menu","menubutton","splitbutton","progressbar","tree","combobox","combotree","combogrid","numberbox","validatebox","searchbox","numberspinner","timespinner","calendar","datebox","datetimebox","slider","layout","panel","datagrid","propertygrid","treegrid","tabs","accordion","window"],parse:function(_2){
var aa=[];
...
_262.panel({border:false,doSize:false,bodyCls:"dialogeasyui-content"});
return _262;
};
function _263(_264){
var opts=$.data(_264,"dialogeasyui").options;
var _265=$.data(_264,"dialogeasyui").contentPanel;
if(opts.toolbar){
if($.isArray(opts.toolbar)){
$(_264).find("div.dialogeasyui-toolbar").remove();
var _266=$("<div class=\"dialogeasyui-toolbar\"><table cellspacing=\"0\" cellpadding=\"0\"><tr></tr></table></div>").prependTo(_264);
var tr=_266.find("tr");
for(var i=0;i<opts.toolbar.length;i++){
var btn=opts.toolbar[i];
if(btn=="-"){
$("<td><div class=\"dialogeasyui-tool-separator\"></div></td>").appendTo(tr);
}else{
var td=$("<td></td>").appendTo(tr);
...
$(opts.toolbar).addClass("dialogeasyui-toolbar").prependTo(_264);
$(opts.toolbar).show();
}
}else{
$(_264).find("div.dialogeasyui-toolbar").remove();
...
$(_264).find("div.dialogeasyui-button").remove();
var _267=$("<div class=\"dialogeasyui-button\"></div>").appendTo(_264);
...
$(opts.buttons).addClass("dialogeasyui-button").appendTo(_264);
$(opts.buttons).show();
}
}else{
$(_264).find("div.dialogeasyui-button").remove();
...
_265.panel("resize",{width:_26d.width(),height:(_26c=="auto")?"auto":_26d.height()-_26d.children("div.dialogeasyui-toolbar")._outerHeight()-_26d.children("div.dialogeasyui-button")._outerHeight()});
if(opts.onResize){
...
var _270=$.data(_26f,"dialogeasyui").contentPanel;
_270.panel("refresh",href);
};
$.fn.dialogeasyui=function(_271,_272){
if(typeof _271=="string"){
var _273=$.fn.dialogeasyui.methods[_271];
if(_273){
...
_271=_271||{};
return this.each(function(){
var _274=$.data(this,"dialogeasyui");
if(_274){
$.extend(_274.options,_271);
}else{
$.data(this,"dialogeasyui",{options:$.extend({},$.fn.dialogeasyui.defaults,$.fn.dialogeasyui.parseOptions(this),_271),contentPanel:_260(this)});
}
_263(this);
});
};
$.fn.dialogeasyui.methods={options:function(jq){
var _275=$.data(jq[0],"dialogeasyui").options;
...
var _277=$.data(jq[0],"dialogeasyui").contentPanel;
return _275;
},dialogeasyui:function(jq){
...
$.fn.dialogeasyui.parseOptions=function(_278){
return $.extend({},$.fn.window.parseOptions(_278),$.parser.parseOptions(_278,["toolbar","buttons"]));
};
$.fn.dialogeasyui.defaults=$.extend({},$.fn.window.defaults,{title:"New dialogeasyui",collapsible:false,minimizable:false,maximizable:false,resizable:false,toolbar:null,buttons:null});
})(jQuery);
(function($){
